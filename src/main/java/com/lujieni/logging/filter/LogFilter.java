package com.lujieni.logging.filter;
...
//        }
        //是JSON格式的才输出
        if (StringUtils.isEmpty(contentType) || contentType.toUpperCase().contains("JSON") || contentType.contains("text")) {
            needLogContentType = true;
        } else {
            needLogContentType = false;
        }
